...
export function MovieCard({ movie, disableHover = false }: MovieCardProps) {
  return (
    <div className={`bg-[#101926] rounded-xl overflow-hidden shadow-lg flex flex-col items-center p-0 w-full ${!disableHover ? 'group cursor-pointer' : ''}`}>
